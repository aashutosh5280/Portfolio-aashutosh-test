        ...
        <SectionWrapper id="contact" className="mb-16 mx-4 lg:mx-0">
            ...
            <div className="w-full lg:w-5/6 2xl:w-3/4 mt-10 md:mt-16 mx-auto flex justify-between rounded-xl">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-gray-400 mb-4 text-sm md:text-base">Feel free to reach out anytime — whether it&apos;s a question, feedback, or just a quick hello. My inbox is always open!💬</p>
